...
public class CameraPreview extends AppCompatActivity implements View.OnClickListener {
    ...
    public static Intent newIntentPhoto(Context context, String filePath) {
        return new Intent(context, CameraPreview.class)
    ...
    @Override
    public void onClick(View view) {
        Intent resultIntent = new Intent(CameraPreview.this, CameraActivity.class);
        if (view.getId() == R.id.confirm_media_result) {
            Intent i = new Intent(this, PostActivity.class);
            i.putExtra("filename", previewFilePath);
            startActivity(i);
        ...
        try {
            ...
            mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                ...
                public void onPrepared(MediaPlayer mp) {
                    mediaController = new MediaController(CameraPreview.this);
